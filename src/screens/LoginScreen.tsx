    ...
    >
      <ScrollView
        contentContainerStyle={[
          ...
          { paddingBottom: insets.bottom + 32, flexGrow: 1, justifyContent: "center" },
        ]}
          ...
          {FEATURES.map((feature) => (
            <View key={feature.title} style={styles.featureItem}>
              <View style={styles.featureIconWrap}>
                <feature.icon color={BRAND_BLUE} size={22} />
              </View>
        ...
        <View style={styles.signUpCard}>
          <View style={styles.signUpIconWrap}>
            <View style={styles.signUpIconInner}>
              <Newspaper color={BRAND_BLUE} size={18} />
            </View>
            <View style={styles.signUpIconBadge}>
              <Bell color="#FFFFFF" size={10} />
            </View>
          </View>
